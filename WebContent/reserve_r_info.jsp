...
<body>
	...
	<table class="type04" style="margin: auto;">
		...
		<tr>
			...
			<td><fmt:formatDate value="${date1}" /></td>
		</tr>
		<tr>
			<th scope="row">시간</th>
			<td>12:00</td>
	...
	<div align="center"><textarea style="resize: none; wrap:hard" readonly="readonly" disabled="disabled" rows="5" cols="80" name="contents">개인정보 수집, 이용 및 제공 등에 관한 고지사항
...
- 입력정보 : 이름, 휴대폰번호, 이메일 주소
	...
	<div align="center">
		<a href="reserve_r_end.jsp"><input type="button" value="다음단계"></a>
