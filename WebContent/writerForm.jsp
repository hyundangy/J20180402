			...
			<form action="writerPro.do?pageNum=${pageNum }" method="post">
				...
				<table class="table table-hover"
					...
					<tbody>
						<tr>
						<td>
							<select class="selectpicker form-control" style="width: 120px;" name="category">
								<option>잡담</option>
								<option>정보</option>
								<option>기타</option>
							</select>
						</td>
							<td style="width: 90%"><input type="text" class="form-control" placeholder="제목"
								name="subject" maxlength="50" required="required"></td>
						</tr>
						<tr>
							<td colspan="2"><textarea class="form-control" placeholder="내용"
									name="content" maxlength="1000" style="height: 300px;" required="required"></textarea></td>
									<td><input type="text" class="form-control" placeholder="아이디" name="id" style="width:100px;"required="required"></td>
					</tbody>
				</table>
				<input type="submit" class="btn btn-info pull-right" value="글쓰기"><br/><br/>
