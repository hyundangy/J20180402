...
<body>
	...
	테마선택 : <select name="r_tema" style="margin-right: 40px">
            <optgroup label="" >
                <option value="ironman">전설의 고향 </option>
	...
	<h3 style="margin-left: 50px;">전설의 고향</h3>
	<hr>
	<table style="margin-top: 30px; margin-bottom: 60px; margin-left: 50px;">
		
		
		<tr>
			<td rowspan="3"><img alt="" src="images/r_theQ_1.JPG" width="220" height="220" style="margin-right: 50px; "></td>
			
			<td><a href='reserve_r_info.jsp' class='buttonY' style="margin-right: 20px; margin-bottom: 20px;">12:00 예약가능</a></td>
			<td><a href='#' class='buttonY' style="margin-right: 20px; margin-bottom: 20px;">13:00 예약가능</a></td>
			<td><a href='#' class='buttonY' style="margin-right: 20px; margin-bottom: 20px;">13:00 예약가능</a></td>
			<td><a href='#' class='buttonN' style="margin-right: 20px; margin-bottom: 20px;">13:00 예약가능</a></td>
			
			
		</tr>
		<tr>
			<td><a href='#' class='buttonN' style="margin-right: 20px; margin-bottom: 20px;">12:00 예약마감</a></td>
			<td><a href='#' class='buttonY' style="margin-right: 20px; margin-bottom: 20px;">13:00 예약가능</a></td>
			<td><a href='#' class='buttonY' style="margin-right: 20px; margin-bottom: 20px;">13:00 예약가능</a></td>
			<td><a href='#' class='buttonN' style="margin-right: 20px; margin-bottom: 20px;">13:00 예약가능</a></td>
		...
		<tr>
			<td><a href='#' class='buttonN' style="margin-right: 20px">12:00 예약마감</a></td>
			<td><a href='#' class='buttonY' style="margin-right: 20px">13:00 예약가능</a></td>
			<td><a href='#' class='buttonY' style="margin-right: 20px">13:00 예약가능</a></td>
			<td><a href='#' class='buttonN' style="margin-right: 20px">13:00 예약가능</a></td>
		</tr>
