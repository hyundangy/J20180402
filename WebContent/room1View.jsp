...
<body>
    ...
    <p><h1 style="color: gray">The QEscape(더큐이스케이프) 강남점</h1><p>
	<h5>서울특별시 강남구</h5><p>
	<img src="images/f_star.png" alt="평점" width="20" height="20">
	<img src="images/f_star.png" alt="평점" width="20" height="20">
	<img src="images/f_star.png" alt="평점" width="20" height="20">
	<img src="images/f_star.png" alt="평점" width="20" height="20">
	<h4>The QEscape에 오신 것을 환영합니다. </h4>
	...
	<div role="tabpanel" style="margin-top: 50px">
 	 ...
 	 <div class="tab-content">
    	...
    	<table>
		<tr>
			<td><br><img src="images/r_theQ_1.JPG" alt="theQ테마" width="180" height="170">		
			<td><h4>전설의 고향</h4><hr> 
				<textarea style="resize: none; wrap:hard; background-color: white; border-color: lightgray" rows="4" cols="100" name="contents" readonly="readonly" disabled="disabled"> 서방님, 백년해로를 약속하시고는 어찌 그리 먼저 가셨나요. 먼저 가신 서방님 생각에 눈물 마를 날 없습니다.
먼저 떠난 남편을 그리워하다 죽은 여인이 살았다는 집. 그런데, 매일 밤- 그녀가 다시 이곳을 찾아오고 있다.
죽어서도 떠나지 못해, 이승을 떠도는 그녀에게 무슨 일이 있었던 것일까.
침묵 속에 갇혀버린 여인의 방, 방을 탈출하지 못하면 죽은 그녀와 마주하게 될 것이다.
		</textarea>
				<a href="reserve_r.jsp" style="margin: auto;"><input type="button" value="예약하기"></a>
			</td>
			
		</tr>
		<tr>
			<td><br><img src="images/r_theQ_2.JPG" alt="theQ테마" width="180" height="170">		
		</tr>
		<tr>
			<td><br><img src="images/r_theQ_3.JPG" alt="theQ테마" width="180" height="170">		
		</tr>
